...
class Pengeluaran extends StatefulWidget {
  ...
  @override
  State<Pengeluaran> createState() => _InsertDataState();
}

class _InsertDataState extends State<Pengeluaran> {
  final keterangan = TextEditingController();
  final nominal = TextEditingController();
  final jenis = 'Pengeluaran';
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text(
                        'Silahkan mengisi pengeluaran anda untuk dijadikan data dalam laporan keuangan anda:',
                        style: TextStyle(
                            fontFamily: "Serif",
                            fontSize: 18,
                            fontWeight: FontWeight.bold,
                      ...
                      TextField(
                        ...
                        decoration: const InputDecoration(
                          ...
                          hintText: 'Masukan keterangan Pengeluaran',
                      ...
                      TextField(
                        ...
                        decoration: const InputDecoration(
                          border: OutlineInputBorder(),
                          labelText: 'Nominal',
                          hintText: 'Masukan nominal Pengeluaran',
                          labelStyle: TextStyle(fontFamily: 'Serif'),
                          hintStyle: TextStyle(fontFamily: 'Serif'),
                        ),
                      ),
